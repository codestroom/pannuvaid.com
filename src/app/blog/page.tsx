...
export const metadata: Metadata = {
  title: "Ayurveda Blog — Health Tips, Herbal Remedies & Wellness",
  description:
  ...
  return (
    <>
      <PageHero
        ...
        description="Practical Ayurvedic guidance on pain relief, herbal remedies, lifestyle, and lasting wellness."
